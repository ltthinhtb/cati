...
class AppTextStyle {
  ...
  static TextStyle h5 = GoogleFonts.roboto(
      fontStyle: FontStyle.normal, fontSize: 26, fontWeight: FontWeight.w700);
  ...
  static TextStyle buttonNormal = GoogleFonts.roboto(
  ...
  static TextStyle bottomNavigatorText = GoogleFonts.roboto(
      fontStyle: FontStyle.normal, fontSize: 10, fontWeight: FontWeight.w400);
}
